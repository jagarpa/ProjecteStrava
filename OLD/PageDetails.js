...
class PageDetails {
  ...
  constructor(activity, container, clientInfo, heartData) {
  ...
  renderActivityDetailsPage() {
    ...
    src = `L.mapbox.accessToken = 'pk.eyJ1IjoiZGpqYXZpZyIsImEiOiJja3VyZmI0ZnUwd3llMnFwNXp6a2c4bWc1In0.GHFEHp5qLR_8GluAxjGMLA'; 
    ...
    backbutton.addEventListener("click", () => {
      new PageActivities (this.clientInfo, this.container)
    })
  }
}
